...
Shader "Custom/SeaShader"
{
        ...
        SubShader
    {
        ...
        // - Standard means standard lighting
        // - vertex:vert to be able to modify the vertices
        // - addshadow to make the shadow look correct after modifying the vertices
        ...
        float3 getWavePos(float3 pos) 
        {
            ...
            float waveType = pos.z * pos.x;

            pos.y += sin((_WaterTime * _WaterSpeed + waveType) / _WaterDistance) * _WaterScale;

            // Add Noise
            pos.y += tex2Dlod(_NoiseTex, float4(pos.x + _WaterNoiseWalk, pos.z + sin(_WaterTime * 0.1), 0.0, 0.0)).a * _WaterNoiseStrength;
